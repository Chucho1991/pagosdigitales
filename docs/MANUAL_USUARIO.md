...
- Proveedor habilitado en BD (`AD_BILLETERAS_DIGITALES`) y WS configurados en `IN_PASARELA_WS`.
...
- Mantener sincronizada la configuracion de WS y headers en BD (`IN_PASARELA_WS`, `IN_PASARELA_HEADERS`).
